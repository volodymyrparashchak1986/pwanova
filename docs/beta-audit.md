...
Проверка: 22–23 сентября 2026. Исходный commit: `c3092fd`. Ветка: `codex/closed-beta-verification`. Это доработка существующей платформы, не workshop/business starter. Стек, основные маршруты и дизайн сохранены. Production не изменялся.
